...
// ... (keep your other AI functions like askQuestion and generatePersonalizedQuiz)
...
exports.generateQuizFromText = async (req, res, next) => {
  ...
  try {
    ...
    // --- THIS IS THE FIX ---
    // Transform the AI data to match our database schema
    const questionsToCreate = parsedQuestions.map(q => {
      ...
      return {
        ...q, // a structured object with questionText, options, correctAnswer, subject, topic
        correctAnswerIndex: correctAnswerIndex,
        examType: 'School Exam', // Hardcode the examType for teacher-generated quizzes
        createdBy: teacherId
      };
    });
    // --- END OF FIX ---
