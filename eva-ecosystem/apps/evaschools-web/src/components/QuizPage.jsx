...
import CreateQuizModal from './CreateQuizModal'; // Import the modal
...
const QuizPage = () => {
  ...
  return (
    <div>
      {isModalOpen && <CreateQuizModal onClose={() => setIsModalOpen(false)} onQuizCreated={handleQuizCreated} />}
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="flex items-center bg-blue-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-blue-700 transition"
        >
